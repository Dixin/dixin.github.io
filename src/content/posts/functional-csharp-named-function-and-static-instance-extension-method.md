...
As part of the discussion of what are C# functions, this chapter explains what are named functions, how to define and use them, their underlying compilation, and their polymorphisms. The other functions are local function as a special named function, and anonymous function, are discussed in individual chapters.